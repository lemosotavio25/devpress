...
1. Clone e instale conforme instruções acima
2. Use as credenciais de admin: test@example.com / password
3. Teste o CRUD completo de artigos
4. Verifique as policies (admin vs developer)
